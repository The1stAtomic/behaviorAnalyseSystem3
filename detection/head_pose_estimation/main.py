...
def run():
    ...
    face_detector = FaceDetector(os.path.join(SCRIPT_DIR, "assets", "face_detector.onnx"))

    # Setup a mark detector to detect landmarks.
    mark_detector = MarkDetector(os.path.join(SCRIPT_DIR, "assets", "face_landmarks.onnx"))
